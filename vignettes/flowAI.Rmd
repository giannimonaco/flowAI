...
After the quality control, the user can store a new FCS file containing an additional column indicating where the low quality events can be gated within the range of 10,000 and 20,000. 
Alternatively a new FCS containing only the high quality events can be produced. 

...
The plot reconstructs the flow rate with a resolution of 1/`r 1/second_fractionFR` of a second. Anomalies in the flow rate are identified with an algorithm based on the generalied ESD outlier detection method. The anomalies are circled in green.
